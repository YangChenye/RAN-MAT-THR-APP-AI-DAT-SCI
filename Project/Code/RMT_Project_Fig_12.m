...
% t = rand(r,1)*0.8;    % independent variable
% Gaussion distribution
t = zeros(r,1);
for i=1:1:r
    t(i,1) = GaussionInab(0.5,0.15,0,1)*0.8;
end
...
figure(1)
x = linspace(0,1)';
y = FourierSeries(x,a,M);
plot(x,y,'r-')
hold on
y_hat = FourierSeries(x,a_hat,M);
plot(x,y_hat,'b--')
hold on
scatter(t,p,'filled')
xlabel('t')
